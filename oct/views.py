...
def model_fun():    
    model_path=os.path.join(settings.MEDIA_ROOT,'octm/02-11 12_16_11model.h5')
...
def oct_modalPridict(request):
    if request.method == 'POST':
        ...
        disease={0:"choroidal neovascularization (CNV)",1:"Diabetic macular edema (DME)",2:"DRUSEN image",3:"NORMAL image",4:"severe"}
        final_disease=''
        for i in disease:
        ...
        return render(request,'oct_modalPridict.html',{
